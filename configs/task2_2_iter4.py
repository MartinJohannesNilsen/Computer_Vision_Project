...
from .task2_1 import model, data_train, data_val, train, optimizer, schedulers, backbone, anchors, loss_objective, label_map
...
Iterations:
 ...
 7. Combination of RandomHorizontalFlip and RandomAdjustSharpness (best after anchor box bug fix)
"""
...
# We have kept the gpu_transform unchanged
